...
export const BRAND = {
  ...
  domain: '150hp.com',
  email: 'contact@mercheking.com',   // ← DO NOT CHANGE — per spec
  phone: '(469) 595-9391',
...
export const products: Product[] = [
  ...
  /* ── ZIP HOODIES ────────────────────────────────────── */
  {
    ...
    image: 'https://i.postimg.cc/mZd52wK9/Grey-Shadow.jpg',
  ...
  },
  {
    ...
    category: 'Zip Hoodies', categorySlug: 'zip-hoodies',
    // ↓ UPDATED — postimg.cc custom image
    image: 'https://i.postimg.cc/8kbHFMNm/3c8f4c21cdcea839c60f943a33f6cc1f2fa7be23.jpg',
    imageAlt: 'Classic zip hoodie',
    imagePlaceholder: 'Classic Zip Hoodie',
    colors: [
      { name: 'Grey',   hex: '#9E9E9E', image: 'https://i.postimg.cc/8kbHFMNm/3c8f4c21cdcea839c60f943a33f6cc1f2fa7be23.jpg' },
  ...
  /* ── TANK TOPS ──────────────────────────────────────── */
  {
    ...
    badge: 'New',
    colors: [
      { name: 'White',      hex: '#FFFFFF', image: 'https://i.postimg.cc/k5xS0P5T/e13d13bf25c1c440f715effda7c404c709de15f1.jpg' },
  ...
  },
  {
    ...
    colors: [
      { name: 'White', hex: '#FFFFFF', image: 'https://i.postimg.cc/Qd7K7ZcZ/af47570fc4558ec013ea061392f37a7bc617ba94.jpg' },
  ...
  /* ── SWEATSHIRTS ────────────────────────────────────── */
  {
    ...
    colors: [
      { name: 'Grey',  hex: '#9E9E9E', image: 'https://i.postimg.cc/xTzLvmSG/44306570-27276-hi.jpg' },
...
export const categories = [
  ...
  { name: 'Sweatshirts', slug: 'sweatshirts', image: 'https://i.postimg.cc/xTzLvmSG/44306570-27276-hi.jpg' },
];
